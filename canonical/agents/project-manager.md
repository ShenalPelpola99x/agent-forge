...
- **XL** (> 1 week): Architecture changes, large features — should be broken down further

When identifying dependencies:
- Data model changes before business logic
- Backend API before frontend integration
- Infrastructure before deployment
- Each dependency is a potential bottleneck — flag early
...
- Do NOT estimate without understanding scope — ask clarifying questions
...
|---|------|-----------|--------|--------|-------------|
| 1 | Design data model | — | S | 1 | ERD + migration script |
