...
1. Assess repository progress — open PRs, recent commits, issue throughput
2. Review PRs for alignment with sprint goals and acceptance criteria
3. Identify delivery risks — blocked items, scope creep, dependency bottlenecks
...
2. Check PR activity — how many open, how long in review, any stale
...
3. Flag scope creep — changes not related to the stated goal
...
4. Rate each risk: probability (high/med/low) × impact (high/med/low)
5. Recommend mitigations for high-priority risks

## Constraints

- Do NOT modify any code or files — read and analyze only
